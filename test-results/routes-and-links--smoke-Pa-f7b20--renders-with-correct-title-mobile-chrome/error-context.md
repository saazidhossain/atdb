...
- Name: routes-and-links.spec.ts >> @smoke Page routes load correctly >> /equipment/excavators renders with correct title
- Location: e2e/routes-and-links.spec.ts:36:5
