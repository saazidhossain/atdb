...
export const equipmentData: EquipmentItem[] = [
  ...
  { id: "ATDB-RR-007", category: "rollers", categoryLabel: "Road Rollers", name: "Advance 3-Wheel Steel Roller", brand: "Advance", model: "3-Wheel Steel", capacity: "8.5 Ton",  origin: "—",      year: 2015, fuel: "Diesel", quantity: "01", notes: "3 Wheel Steel Roller",        image: "/assets/advance-3wheel-AY1qh_Tr.webp", banglaLabel: "অ্যাডভান্স ৩-হুইল" },
  { id: "ATDB-RR-008", category: "rollers", categoryLabel: "Road Rollers", name: "Sakai HV60ST Mini Tandem",     brand: "Sakai",   model: "HV60ST",        capacity: "1/2 Ton",  origin: "Japan",  year: 2015, fuel: "Diesel", quantity: "01", notes: "2 Drum Steel Vibratory",      image: "/assets/sakai-mini-DjZpy-kY.webp", featured: true, banglaLabel: "সাকাই HV60 মিনি ট্যান্ডেম",
  ...
  // ─── D. SUPPORT EQUIPMENT (9 line items, master list) ──────────────
  ...
  { id: "ATDB-SP-004", category: "support", categoryLabel: "Support Equipment", name: "Honda 80k-100 Sand Compactor (Rammer)", brand: "Honda", model: "80k-100", capacity: "Sand Rammer", origin: "Japan", year: 2021, fuel: "Petrol", quantity: "02", notes: "Sand / Soil Tamping Rammer", image: "/assets/support-tools-Dnowl7z-.webp", banglaLabel: "হোন্ডা ৮০কে স্যান্ড কম্প্যাক্টর",
  ...
  { id: "ATDB-SP-005", category: "support", categoryLabel: "Support Equipment", name: "Honda ER2500CX Generator",        brand: "Honda",    model: "ER2500CX",    capacity: "2.5 kVA",         origin: "Japan", year: 2020, fuel: "Petrol",   quantity: "03", notes: "Portable Inverter Generator", image: FALLBACK.support, banglaLabel: "হোন্ডা ER2500CX জেনারেটর",
    realPhotos: ["/equipment/ATDB-SP-005/ATDB-SP-005-01.webp"] },
  { id: "ATDB-SP-006", category: "support", categoryLabel: "Support Equipment", name: "Zhejiang BS-8000WT Generator",    brand: "Zhejiang", model: "BS-8000WT",   capacity: "8 kVA",           origin: "China", year: 2020, fuel: "Diesel",   quantity: "01", notes: "Portable Site Generator", image: FALLBACK.support, banglaLabel: "ঝেজিয়াং জেনারেটর" },
  ...
  { id: "ATDB-SP-008", category: "support", categoryLabel: "Support Equipment", name: "Honda GXCR200ST Big Drill Hammer", brand: "Honda",   model: "GXCR200ST",   capacity: "Drill Hammer",    origin: "Japan", year: 2021, fuel: "Petrol",   quantity: "05", notes: "Heavy-Duty Drill Hammer", image: FALLBACK.support, banglaLabel: "হোন্ডা ড্রিল হ্যামার" },
  { id: "ATDB-SP-009", category: "support", categoryLabel: "Support Equipment", name: "TATA T7 Ultra Drum Truck",        brand: "TATA",     model: "T7 Ultra",    capacity: "Drum Truck",      origin: "India", year: 2020, fuel: "Diesel",   quantity: "02", notes: "Site Drum / Cargo Truck", image: "/assets/tata-truck-k27qoXaB.webp", banglaLabel: "টাটা T7 আল্ট্রা ড্রাম ট্রাক" },
];
