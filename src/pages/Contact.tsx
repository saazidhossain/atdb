      ...
      <section className="pt-28 pb-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-white/50 mt-4 max-w-2xl">
            {t(
              "Reach us on WhatsApp for the fastest response, or contact our offices directly.",
              "দ্রুততম রেসপন্সের জন্য হোয়াটসঅ্যাপে যোগাযোগ করুন, অথবা সরাসরি আমাদের অফিসে কল করুন।",
            )}
          </p>
        </div>
      </section>
      ...
      <section className="pb-24">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
          <a
            ...
            className="glass-card rounded-2xl p-8 glass-hover card-tilt group text-center"
          >
            ...
            <p className="text-white/50 text-sm">
              {t(
                "Fastest response — direct to leadership",
                "দ্রুততম রেসপন্স — সরাসরি নেতৃত্বের সাথে",
              )}
            </p>
          </a>
          ...
          >
            ...
            <p className="text-white/70 text-sm break-all">
              +8801712106242 <span className="text-white/40">· {t("Proprietor", "মালিক")}</span>
            </p>
            <p className="text-white/70 text-sm mt-1 break-all">
              +8801816666067 <span className="text-white/40">· {t("CEO", "সিইও")}</span>
            </p>
          </a>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-12 grid grid-cols-1 md:grid-cols-2 gap-5">
          {[
            ...
            <div
              key={office.name}
              className="glass-card rounded-2xl p-6 glass-hover card-tilt flex gap-4"
            >
