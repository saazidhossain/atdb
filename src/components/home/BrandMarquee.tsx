...
export default function BrandMarquee() {
  ...
  return (
    <section className="py-10 border-y border-white/5 overflow-hidden bg-background/50 max-w-[100vw]">
      <p className="text-center text-xs font-mono tracking-[0.3em] text-white/30 uppercase mb-6 px-4">{t("Trusted brands in our fleet", "আমাদের ফ্লিটের ব্র্যান্ডসমূহ")}</p>
      <div className="relative w-full overflow-hidden">
        ...
        <div className="flex animate-marquee whitespace-nowrap w-max will-change-transform">
          {allBrands.map((brand, i) => (
            <span key={i} className="mx-6 sm:mx-8 text-white/40 font-semibold text-base sm:text-lg tracking-wide flex items-center gap-3 shrink-0">
